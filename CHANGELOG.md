...
- Added Totem of Light
  - Totem of Light cleanses Deep Dark corrution effect for user and players in the surrounding area
- Added Nether burn upon entry
- Added Fire Resistance to certain foods
  - Configurable, TBD
...
- some items names may change as the mod is finalized