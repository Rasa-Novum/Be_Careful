...
import net.rasanovum.hardernether.effects.CorruptionEffect;
import net.rasanovum.hardernether.effects.TotemOfLight;
import net.rasanovum.hardernether.spawning.EndPhantomSpawner;
import net.rasanovum.hardernether.spawning.EndSpawnHandler;
import net.rasanovum.hardernether.portals.AncientPortalHandler;
import net.rasanovum.hardernether.util.*;
